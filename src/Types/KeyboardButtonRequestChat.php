 ...
 * @method ?bool chatIsForum()
 * @method ?bool chatHasUsername()
 * @method ?bool chatIsCreated()
 * @method ?ChatAdministratorRights userAdministratorRights()
 * @method ?ChatAdministratorRights botAdministratorRights()
 * @method ?bool botIsMember()
 *
 * @method static setRequestId(int $requestId)
 * @method static setChatIsChannel(bool $chatIsChannel)
 * @method static setChatIsForum(?bool $chatIsForum)
 * @method static setChatHasUsername(?bool $chatHasUsername)
 * @method static setChatIsCreated(?bool $chatIsCreated)
 ...
 * @method static setBotIsMember(?bool $botIsMember)
 *
