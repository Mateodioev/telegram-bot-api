 ...
 * @property boolean $can_invite_users            Optional. True, if the user is allowed to invite new users to the chat $can_invite_users Optional. True, if the user is allowed to invite new users to the chat
