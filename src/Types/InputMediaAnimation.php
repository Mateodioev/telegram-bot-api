 ...
 * @property string|null $caption Optional. Caption of the animation to be sent, 0-1024 characters after entities parsing
 * @property string|null $parse_mode Optional. Mode for parsing entities in the animation caption. See formatting options for more details.
 ...
 * @property int|null $duration Optional. Animation duration in seconds
 * @property bool|null $has_spoiler Optional. Pass True if the animation needs to be covered with a spoiler animation
 *
 * @method string type()
 * @method string media()
