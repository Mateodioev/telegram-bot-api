 ...
 * @property WebAppInfo|null $web_app Optional. Description of the Web App that will be launched when the user presses the button. The Web App will be able to switch back to the inline mode using the method switchInlineQuery inside the Web App.
 ...
 * @method string|null startParameter()
 *
 * @method static setText(string $text)
 * @method static setWebApp(WebAppInfo|null $webApp)
 * @method static setStartParameter(string|null $startParameter)
 *
