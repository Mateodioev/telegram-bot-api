 ...
 * @property User|null $completed_by_user Optional. User that completed the task; omitted if the task wasn't completed by a user
 * @property Chat|null $completed_by_chat Optional. Chat that completed the task; omitted if the task wasn't completed by a chat
 ...
 * @method Chat|null completedByChat()
 ...
 * @method static setCompletedByChat(Chat|null $completedByChat)
...
class ChecklistTask extends abstractType
{
    protected function boot(): void
    {
        $this->fields = [
            ...
            'completed_by_chat' => FieldType::optional(Chat::class),
