 ...
 *
 * @property MaybeInaccessibleMessage|null $poll_message Optional. Message containing the poll from which the option was deleted, if known. Note that the Message object in this field will not contain the reply_to_message field even if it itself is a reply.
 ...
 */
class PollOptionDeleted extends abstractType
{
