 ...
 * @property string $origin Origin of the gift. Currently, either "upgrade" for gifts upgraded from regular gifts, "transfer" for gifts transferred from other users or channels, or "resale" for gifts bought from other users
 * @property int|null $last_resale_star_count Optional. For gifts bought from other users, the price paid for the gift
 ...
 * @method int|null lastResaleStarCount()
 ...
 * @method static setLastResaleStarCount(int|null $lastResaleStarCount)
...
class UniqueGiftInfo extends abstractType
{
    protected function boot(): void
    {
        $this->fields = [
            ...
            'last_resale_star_count' => FieldType::optional('integer'),
