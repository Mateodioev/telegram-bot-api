 ...
 * @property int|null $unix_time Optional. For "date_time" only, the Unix time associated with the entity
 * @property string|null $date_time_format Optional. For "date_time" only, the string that defines the formatting of the date and time. See date-time entity formatting for more details.
 *
 * @method string type()
 * @method int offset()
 * @method int length()
 ...
 * @method int|null unixTime()
 * @method string|null dateTimeFormat()
 *
 ...
 * @method static setUnixTime(int|null $unixTime)
 * @method static setDateTimeFormat(string|null $dateTimeFormat)
 *
...
class MessageEntity extends abstractType
{
    protected function boot(): void
    {
        $this->fields = [
            ...
            'unix_time'        => FieldType::optional('integer'),
            'date_time_format' => FieldType::optional('string'),
        ];
