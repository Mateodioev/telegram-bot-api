...
trait Stickers
{
  public function sendSticker(string|int $chatId, InputFile $sticker, array $params = []): fakeStdClass
  {
  ...
  public function getStickerSet(string $name): fakeStdClass
  {
    return $this->request('getStickerSet', ['name' => $name]);
  }

  public function getCustomEmojiStickers(array $customIds): fakeStdClass
  {
   ...
   */
  public function uploadStickerFile(int $userId, InputFile $pngSticker): fakeStdClass
  {
  ...
  public function createNewStickerSet(int $userId, string $name, string $title, array $params = []): fakeStdClass
  {
  ...
  public function addStickerToSet(int $userId, string $name, string $emojis, ?InputFile $pngSticker = null, ?InputFile $tgSticker=null, ?InputFile $webmSticker=null, ?MaskPosition $maskPosition=null): fakeStdClass
  {
  ...
  public function deleteStickerFromSet(string $sticker): fakeStdClass
  {
    return $this->request('deleteStickerFromSet', ['sticker' => $sticker]);
  }

  public function setStickerSetThumb(string $name, int $userId, InputFile $thumb): fakeStdClass
  {
